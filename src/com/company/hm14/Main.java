...
public class Main {
    ...
    /*1. Создать метод convertToUnique. Метод принимает строковый список заполненный произвольными значениями,
...
*/
    ...
    заполненный произвольными значениями, которые могут повторяться. Необходимо вернуться последовательность целочисленных значений,
    ...
    */
    ...
    заполненный произвольными значениями, которые могут повторяться.
    Необходимо вернуться последовательность целочисленных значений,
 ...
 /*4. * Создать метод buildSentenceDirection.
    Метод принимает на вход набор строковых значений, заполненный произвольными значениями,
    которые могут повторяться. Необходимо вернуться последовательность строковых значений, но без учета
    повторений, которые сохранят последовательность вставки после создания такой последовательности.
    Например:
        Дано: [Привет, Мир, Привет, !, !]
